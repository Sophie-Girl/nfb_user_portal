...
class edit_create_contnet
{
    ...
    public function build_form_array(&$form, FormStateInterface $form_state, $content)
    {
        ...
        $form['intro_text'] = array(
          '#type' => "item",
          "#markup" => "<p>Here is the intro text, I'm not really sure what to say here. 
...
still exists, or dates on the markup. </p>"
        );
        $form['tab'] = array(
...
<div id='ajax_wrap'>",
        ...
        $form['submit'] = array(
            '#type' => 'submit',
            '#value' => $text,
            '#suffix' => "<a id='clear-filter' href='/member_portal/admin/manage_content' style='display: inline-block' role='button' class='btn btn-default'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a>");
    }
