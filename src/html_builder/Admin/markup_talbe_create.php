...
class markup_talbe_create extends markup_table_edit {
    ...
    public function build_form_array(&$form, FormStateInterface  $form_state)
    {
        ...
        $form['intro'] = array(
         ...
         You can create a new piece of content by clicking this button</p><a class='btn btn-primary' role='button' href='/member_profile/admin/content/new'>&nbsp;&nbsp;&nbsp;Create&nbsp;&nbsp;&nbsp;</a>"
        );
    ...
    public function build_table_row($content, $markup_array)
    {
        ...
        <td>".$content['limiter']."</td><td>".$this->find_civi_entity_title($content)."</td><td>".$this->yes_no($content)."</td><td>".$markup_array['weight']."</td><td><a href='/member_profile/admin/content/".$content['cid']."' role='button' aria-label='Edit '>Edit</a></td></tr>";
