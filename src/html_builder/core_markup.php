...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form'  id='prim_state_edit_div' class='hidden_val' ><label for='prim_country_new_val'  t  id='prim_country_new_val_lab' >Country:</label><select id='prim_country_new_val' class='form-control' tabindex='0' aria-label='enter new primary country'>".$this->country_options()."</select>
