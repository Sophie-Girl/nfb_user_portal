...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div  role='form'  id='first_name_edit_div' aria-live='polite' class='hidden_val'><input  tabindex='0' id='f_name_new_val' class= 'feild_custom_text'aria-label='enter new first name'></input><a  tabindex='0' role='button' id='save_f_name'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_f_name' tabindex='0'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite'  id='last_name_edit_div' class='hidden_val' ><input tabindex='0'  id='l_name_new_val' class= 'feild_custom_text' aria-label='enter new last name'></input>&nbsp;&nbsp;&nbsp;<a tabindex='0'  role='button' id='save_l_name'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a tabindex='0'  role='button' id='cancel_l_name'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite'  id='prim_email_edit_div' class='hidden_val'><input tabindex='0'  id='prim_email_new_val' class= 'feild_custom_text' aria-label='enter new primary email'></input>&nbsp;&nbsp;&nbsp;<a tabindex='0' role='button' id='save_prim_email'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0'  id='cancel_prim_email'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='prim_phone_edit_div' class='hidden_val'><input tabindex='0' id='prim_phone_new_val' class= 'feild_custom_text' aria-label='enter new primary phone'></input>&nbsp;&nbsp;&nbsp;<a tabindex='0'  role='button' id='save_prim_phone'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a> &nbsp;&nbsp;&nbsp;<a role='button'  tabindex='0' id='cancel_prim_phone'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='prim_street_edit_div' class='hidden_val'><input tabindex='0' id='prim_street_new_val' class= 'feild_custom_text' aria-label='enter new primary street address'></input>&nbsp;&nbsp;&nbsp;<a tabindex='0' role='button' id='save_prim_street'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_prim_street'  tabindex='0'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='prim_city_edit_div' class='hidden_val'><input id='prim_city_new_val'  tabindex='0'  class= 'feild_custom_text' aria-label='enter new primary City'></input>&nbsp;&nbsp;&nbsp;<a role='button' id='save_prim_city' tabindex='0' >&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_prim_city'  tabindex='0'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='prim_zip_edit_div' class='hidden_val'><input tabindex='0' id='prim_zip_new_val' class= 'feild_custom_text' aria-label='enter new primary zip code'></input>&nbsp;&nbsp;&nbsp;<a tabindex='0' role='button' id='save_prim_zip'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a  tabindex='0' role='button' id='cancel_prim_zip'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='lang_pref_edit_div' class='hidden_val'><label  tabindex='0' for='lang_pref_new_val' id='lang_pref_new_val_lab'>Preferred Langauge:</label><select id='lang_pref_new_val' class='feild_custom_select' aria-label='enter new language prefference'  tabindex='0'>".$this->language_options()."</select>
                    ...
                    <div role='form' aria-live='polite' id='pronouns_edit_div' class='hidden_val'><input tabindex='0' id='pronouns_new_val' class= 'feild_custom_text' aria-label='enter new pronouns'></input>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' id='save_pronouns'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' id='cancel_pronouns'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='dob_edit_div' class='hidden_val'><input id='dob_new_val' type='date' class= 'feild_custom_date' aria-label='enter new date of birth' tabindex='0' ></input>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' id='save_dob' tabindex='0'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0'  id='cancel_dob' tabindex='0'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='disability_edit_div' class='hidden_val'><input id='disability_new_val' class= 'feild_custom_text' tabindex='0' aria-label='enter new disability information'></input>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' id='save_disability'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' id='cancel_disability'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='media_type_edit_div' class='hidden_val'><label for='nedia_type_new_val' id='media_type_new_val_lab' tabindex='0'>New Media Preference:</label><select id='media_type_new_val' class='feild_custom_select' tabindex='0' aria-label='Change Meida Type status'>".$this->media_options()."</select>
