...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form' aria-live='polite' id='media_type_edit_div' class='hidden_val'><label for='nedia_type_new_val' id='media_type_new_val_lab' tabindex='0'>Media Preference:</label><select id='media_type_new_val' class='feild_custom_select' tabindex='0' aria-label='Change Meida Type status'>".$this->media_options()."</select>
