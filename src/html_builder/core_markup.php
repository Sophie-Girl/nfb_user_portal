...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <p tabindex='0' id='prime_street'><span id='street_repalce'>Street Address Line 1: ".$this->user_data->get_prime_street()." </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  tabindex='0' role='button' aria-label='Edit Primary Street Address' id='edit_prim_street'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                    <div role='form' aria-live='polite' id='prim_street_edit_div' class='hidden_val'><input tabindex='0' id='prim_street_new_val' class= 'feild_custom_text' aria-label='enter new primary street address'></input>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_prim_street'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a tabindex='0' role='button' id='save_prim_street'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='prim_city_edit_div' class='hidden_val'><input id='prim_city_new_val'  tabindex='0'  class= 'feild_custom_text' aria-label='enter new primary City'></input>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_prim_city'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' id='save_prim_city' tabindex='0' >&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a></div>
                    ...
                    <div role='form' aria-live='polite' id='prim_state_edit_div' class='hidden_val' tabindex='0' ><label for='prim_country_new_val'  tabindex='0'  id='prim_country_new_val_lab' >Country:</label><select id='prim_country_new_val' class='feild_custom_select' tabindex='0' aria-label='enter new primary country'>".$this->country_options()."</select>
