...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form' aria-live='polite' id='pronouns_edit_div' class='hidden_val'><input tabindex='0' id='pronouns_new_val' class= 'feild_custom_text' aria-label='form-control'></input>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' id='save_pronouns'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' id='cancel_pronouns'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
