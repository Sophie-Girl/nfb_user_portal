...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form' aria-live='polite' id='lang_pref_edit_div' class='hidden_val'><label  tabindex='0' for='lang_pref_new_val' id='lang_pref_new_val_lab'>Prefeerred Langauge:</label><select id='lang_pref_new_val' class='feild_custom_select' aria-label='enter new language prefference'  tabindex='0'>".$this->language_options()."</select>
