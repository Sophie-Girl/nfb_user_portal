...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form' aria-live='polite' id='prim_street_edit_div' class='hidden_val'><input tabindex='0' id='prim_street_new_val' class= 'form-control' aria-label='enter new primary street address'></input><br>&nbsp;&nbsp;&nbsp;<a tabindex='0' role='button' id='save_prim_street' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_prim_street' class='btn btn-default btn-sm' tabindex='0'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                     <br> <p tabindex='0' id='prime_address_2'><span id='line_2_replace'>Street Address Line 2: ".$this->user_data->get_prime_line_2()." &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Edit Primary Address Line 2' id='edit_prim_address_2'  tabindex='0' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                   ...
                   <br> <p tabindex='0' id='prime_city'><span id='city_replace'>City: ".$this->user_data->get_prime_city()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Edit Primary City' id='edit_prim_city'  tabindex='0' class='btn btn-primary btn-sm' >&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                   ...
                   <br> <p  tabindex='0' id='prime_st_ct'><span id='state_repalce'> State, Country: ".$this->user_data->get_prime_state().", ".$this->user_data->get_prime_country()." </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Edit Primary State and Country'  tabindex='0'  id='edit_prim_state' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                   ...
                   <br> <p id='prime_zip' tabindex='0'><span id='postal_repalce'>ZIP/Postal Code: ".$this->user_data->get_prime_zip()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Edit Primary Zip' id='edit_prim_zip' tabindex='0' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                   ...
                   <br> <p  tabindex='0' id='prime_lnag_pref'><span id='lang_repalce'>Prefered Langauge: ".$this->user_data->get_preferred_language()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Edit Your Preffered Langauge' id='edit_lang_pref' class='btn btn-primary btn-sm' tabindex='0'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                  ...
                  <br>  <p id='braille_info' tabindex='0'><span id='braille_replace'>Brialle Reader? ".$this->user_data->get_braille_reader()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Change your Braille Reader status' tabindex='0' id='edit_braille' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                   ...
                   <br> <p id='dog_info' tabindex='0'><span id='dog_replace'>Guide Dog User? ".$this->user_data->get_dog_user()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Change your guide dog user status' tabindex='0' id='edit_dog' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
