...
class core_markup
{
    ...
    public function look_for_intro_text()
    {
        $key = "cid";
        $query = "select * from nfb_user_portal_content where markup_type = 'intro_text' and tab = 'profile' and active = '0';";
...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <br><p tabindex='0' id='prime_street'><span id='street_replace'>Street Address Line 1: ".$this->user_data->get_prime_street()." </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  tabindex='0' role='button' aria-label='Edit Primary Address' class='btn btn-primary btn-sm' id='edit_prim_street'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                    <p tabindex='0' id='prime_address_2'><span id='line_2_replace'>Street Address Line 2: ".$this->user_data->get_prime_line_2()."</span></p>
                    <p tabindex='0' id='prime_city'><span id='city_replace'>City: ".$this->user_data->get_prime_city()."</span>, <span id='state_repalce'>".$this->user_data->get_prime_state().", ".$this->user_data->get_prime_country()." </span>&nbsp;<span id='postal_repalce'>".$this->user_data->get_prime_zip()."</span></p>
                    <div role='form'  id='prim_street_edit_div' class='hidden_val'><label for='prim_street_new_val' id='prim_street_new_val_lab' >Street Address:</label><input tabindex='0' id='prim_street_new_val' class= 'form-control' aria-label='enter new primary street address'></input></div>
                    <div role='form'  id='prim_address_2_edit_div' class='hidden_val'><label for='prim_address_2_new_val' id='prim_address_2_new_val_lab' >Street Address Line 2:</label><input tabindex='0' id='prim_address_2_new_val' class= 'form-control' aria-label='enter new primary address line 2'></input><br>&nbsp;&nbsp;&nbsp;</div>
                    <div role='form'  id='prim_city_edit_div' class='hidden_val'><label for='prim_city_new_val' id='prim_city_new_val_lab' >City:</label><input id='prim_city_new_val'  tabindex='0'  class= 'form-control' aria-label='enter new primary City'></input></div>
                    <div role='form'  id='prim_state_edit_div' class='hidden_val' ><label for='prim_country_new_val'    id='prim_country_new_val_lab' >Country:</label><select id='prim_country_new_val' class='form-control' tabindex='0' aria-label='enter new primary country'>".$this->country_options()."</select>
                    <label id='prim_state_new_val_lab' for='prim_state_new_val'>State:</label><select id='prim_state_new_val' class='form-control' aria-label='enter new primary state' tabindex='0'>".$this->state_options()."</select></div>
                    <div role='form'  id='prim_zip_edit_div' class='hidden_val'><label for='prim_zip_new_val' id='prim_zip_new_val_lab' >Zip/Postal Code:</label><input tabindex='0' id='prim_zip_new_val' class= 'form-control' aria-label='enter new primary zip code'></input><br>&nbsp;&nbsp;&nbsp;<a tabindex='0' role='button' id='save_prim_zip' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a  tabindex='0' role='button' id='cancel_prim_zip' class='btn btn-default btn-sm'  >&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a></div>
                 ...
                 <br> <p id='blind_info' tabindex='0'><span id='blind_replace'>Blind: ".$this->user_data->get_is_blimd()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' aria-label='Change your blindness status' id='edit_blind' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                  ...
                  <br>  <p id='braille_info' tabindex='0'><span id='braille_replace'>Braille Reader: ".$this->user_data->get_braille_reader()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Change your Braille Reader status' tabindex='0' id='edit_braille' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                    ...
                    <br> <p id='deaf_info' tabindex='0'><span id='deaf_replace'>Deafblind: ".$this->user_data->get_deaf()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0' aria-label='Change your deafblind status' id='edit_deaf' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                    <div role='form'  id='deaf_edit_div' class='hidden_val'><label for='deaf_new_val'id='deaf_new_val_lab'>Deafblind:</label><select id='deaf_new_val' tabindex='0'class='form-control' aria-label='Change Deafness status'>".$this->yes_no()."</select>
                  ...
                  // Remove other disability due to civi issues
         ...
         $markup = $markup ."
                    <br> <p  tabindex='0' id='prime_lnag_pref'><span id='lang_repalce'>Preferred Language: ".$this->user_data->get_preferred_language()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Edit Your Preffered Language' id='edit_lang_pref' class='btn btn-primary btn-sm' tabindex='0'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
