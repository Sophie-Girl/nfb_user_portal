...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form' aria-live='polite' id='prim_phone_edit_div' class='hidden_val'><input tabindex='0' id='prim_phone_new_val' class= 'feild_custom_text' aria-label='enter new primary phone'></input>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a tabindex='0'  role='button' id='save_prim_phone'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a> &nbsp;&nbsp;&nbsp;<a role='button'  tabindex='0' id='cancel_prim_phone'></div>
                    ...
                    <div role='form' aria-live='polite' id='prim_address_2_edit_div' class='hidden_val'><input tabindex='0' id='prim_address_2_new_val' class= 'feild_custom_text' aria-label='enter new primary address line 2'></input>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_prim_address_2'  tabindex='0' >&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' tabindex='0'  id='save_prim_address_2'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a></div>
