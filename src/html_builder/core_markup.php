...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form'  id='prim_address_2_edit_div' class='hidden_val'><input tabindex='0' id='prim_address_2_new_val' class= 'form-control' aria-label='enter new primary address line 2'></input><br>&nbsp;&nbsp;&nbsp;</div>
                    <div role='form'  id='prim_city_edit_div' class='hidden_val'><input id='prim_city_new_val'  tabindex='0'  class= 'form-control' aria-label='enter new primary City'></input><br></div>
