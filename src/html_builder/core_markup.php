...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   ...
                   <br> <p  tabindex='0' id='prime_lnag_pref'><span id='lang_repalce'>Prefered Langauge: ".$this->user_data->get_preferred_language()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Edit Your Preffered Langauge' id='edit_lang_pref' class='btn btn-primary btn-sm' tabindex='0'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                    <div role='form'  id='lang_pref_edit_div' class='hidden_val'><label  tabindex='0' for='lang_pref_new_val' id='lang_pref_new_val_lab'>Preferred Langauge:</label><select id='lang_pref_new_val' class='form-control' aria-label='enter new language prefference'  tabindex='0'>".$this->language_options()."</select>
                  ...
                  <br>  <p id='braille_info' tabindex='0'><span id='braille_replace'>Brialle Reader? ".$this->user_data->get_braille_reader()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Change your Braille Reader status' tabindex='0' id='edit_braille' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                   ...
                   <br> <p id='dog_info' tabindex='0'><span id='dog_replace'>Guide Dog User? ".$this->user_data->get_dog_user()."</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Change your guide dog user status' tabindex='0' id='edit_dog' class='btn btn-primary btn-sm'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></p>
                    <div role='form'   id='dog_edit_div' class='hidden_val'><label for='dog_new_val' id='dog_new_val_lab' tabindex='0'>Guide Dog User?</label><select tabindex='0' id='dog_new_val' tabindex='0' class='form-control' aria-label='Change guide dog user status'>".$this->yes_no()."</select>
