...
<p class='hidden_val' id='edit_open'>Not Open</p>
                   <p class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form' aria-live='polite' id='media_type_edit_div' class='hidden_val'><label for='nedia_pref_new_val' id='media_pref_new_val_lab'>Deaf Blind?</label><select id='media_type_new_val' class='feild_custom_select' aria-label='Change Meida Type status'>".$this->yes_no()."</select>
