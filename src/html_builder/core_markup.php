...
<p class='hidden_val' id='edit_open'>Not Open</p>
                   <p class='hidden_val' id='open_field'>None</p>
                    ...
                    <div id='prim_phone_edit_div' class='hidden_val'><input id='prim_phone_new_val' class= 'feild_custom_text' aria-label='enter new primary phone'></input>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_prim_phone'>Cancel</a><a role='button' id='save-prim-phone'>Save</a></div>
                    ";
