...
<p class='hidden_val' id='edit_open'>Not Open</p>
                   <p class='hidden_val' id='open_field'>None</p>
                    ...
                    <form>
                    <div  id='f_name' style='display: inline'><span id='first_name_repalce'>First Name: ".$this->user_data->get_first_name()."</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a role='button' aria-label='Edit first Name' style='display: inline' id='edit_f_name'>&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a></div>
