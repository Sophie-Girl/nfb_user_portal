...
<p class='hidden_val' tabindex='0' id='edit_open'>Not Open</p>
                   <p tabindex='0' class='hidden_val' id='open_field'>None</p>
                    ...
                    <div role='form' aria-live='polite' id='dob_edit_div' class='hidden_val'><input id='dob_new_val' type='date' class= 'feild_custom_date' aria-label='enter new date of birth'></input>&nbsp;&nbsp;&nbsp;<a role='button' id='cancel_dob' tabindex='0'>&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a role='button' id='save_dob' tabindex='0'>&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</a></div>
